...
type IAnimationCallback = (timestamp: number, delta: number) => void;
...
export class Animator {
  ...
  frame(t) {
    ...
    this.timestamp    = t != null ? t : (this.timestamp + (this.msecDelay != null ? this.msecDelay : DEFAULT_FRAME_DELAY));
...
export class TransitionAnimator extends Animator {
  ...
  update(t) {
    ...
    if (transitions.length) { return this.queue.unshift(transitions); }
  }
};
